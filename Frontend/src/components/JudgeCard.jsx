...
const JudgeCard = ({ judge }) => {
  ...
  const theme = isValid
    ? {
        accentClass: 'text-emerald-400 border-emerald-500/20 bg-emerald-950/20',
        ...
        glowClass: 'glow-emerald border-emerald-900/30',
    ...
    : {
        accentClass: 'text-amber-400 border-amber-500/20 bg-amber-950/20',
        ...
        glowClass: 'glow-amber border-amber-900/30',
        icon: <AlertTriangle className="w-8 h-8 text-amber-400 animate-bounce" style={{ animationDuration: '3s' }} />,
    ...
    <div className={`glass-panel rounded-2xl p-6 transition-all duration-300 ${theme.glowClass} flex flex-col h-full`}>
      ...
      <div className="flex justify-between items-start mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider block">VALIDASI AI JUDGE</span>
      ...
      <div className="mb-6 bg-slate-950/50 p-4 rounded-xl border border-slate-900">
        ...
        <div className="w-full bg-slate-900 rounded-full h-3 overflow-hidden border border-slate-800 p-[1px]">
          <div
      ...
      <div className="flex-grow flex flex-col">
        ...
        <div className="flex-grow bg-slate-950/40 border border-slate-900/60 rounded-xl p-4 text-slate-300 text-sm leading-relaxed max-h-[180px] overflow-y-auto font-medium">
