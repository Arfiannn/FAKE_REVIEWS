...
const PredictionCard = ({ analysis }) => {
  ...
  const theme = isPalsu
    ? {
        accentClass: 'text-rose-400 border-rose-500/20 bg-rose-950/20',
        badgeBg: 'bg-rose-500/10 border border-rose-500/30 text-rose-400',
        progressBar: 'bg-gradient-to-r from-orange-500 to-rose-500',
        glowClass: 'glow-rose border-rose-900/30',
    ...
    <div className={`glass-panel rounded-2xl p-6 transition-all duration-300 ${theme.glowClass} flex flex-col h-full`}>
      ...
      <div className="flex justify-between items-start mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider block">PREDIKSI SISTEM</span>
